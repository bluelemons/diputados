...
=== Funcionalidades
* El prototipo tendrá 3 vistas, un buscador, un listado y un detalle de expedientes. como también 2 tipos de impresiones para las 2 últimas vistas.
* Será multi-usuario y podrá accederse a traves de internet.
* La base de datos se actulizará con los datos dbf del sistema en FoxPro.
